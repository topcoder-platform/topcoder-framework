...
export type ResourceRolePhaseDependencyService =
  typeof ResourceRolePhaseDependencyService;
export const ResourceRolePhaseDependencyService = {
  ...
  lookup: {
    ...
    responseDeserialize: (value: Buffer) =>
      ResourceRolePhaseDependency.decode(value),
  },
  create: {
    ...
    requestSerialize: (value: CreateResourceRolePhaseDependencyInput) =>
      Buffer.from(
        CreateResourceRolePhaseDependencyInput.encode(value).finish()
      ),
    requestDeserialize: (value: Buffer) =>
      CreateResourceRolePhaseDependencyInput.decode(value),
    responseSerialize: (value: ResourceRolePhaseDependency) =>
      Buffer.from(ResourceRolePhaseDependency.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ResourceRolePhaseDependency.decode(value),
  ...
  delete: {
    ...
    responseDeserialize: (value: Buffer) =>
      ResourceRolePhaseDependencyList.decode(value),
  },
} as const;

export interface ResourceRolePhaseDependencyServer
...
export interface ResourceRolePhaseDependencyClient extends Client {
  ...
  lookup(
    ...
    callback: (
      ...
      response: ResourceRolePhaseDependency
    ) => void
  ): ClientUnaryCall;
  lookup(
    request: LookupCriteria,
  ...
  delete(
    ...
    callback: (
      error: ServiceError | null,
      response: ResourceRolePhaseDependencyList
    ) => void
  ): ClientUnaryCall;
  delete(
    request: LookupCriteria,
