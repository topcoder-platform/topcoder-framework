...
export const ResourceRoleService = {
  ...
  lookup: {
    ...
    responseSerialize: (value: ResourceRole) =>
      Buffer.from(ResourceRole.encode(value).finish()),
  ...
  create: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateResourceRoleInput) =>
      Buffer.from(CreateResourceRoleInput.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      CreateResourceRoleInput.decode(value),
    responseSerialize: (value: ResourceRole) =>
      Buffer.from(ResourceRole.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResourceRole.decode(value),
  },
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateResourceRoleInput) =>
      Buffer.from(UpdateResourceRoleInput.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      UpdateResourceRoleInput.decode(value),
    responseSerialize: (value: ResourceRoleList) =>
      Buffer.from(ResourceRoleList.encode(value).finish()),
