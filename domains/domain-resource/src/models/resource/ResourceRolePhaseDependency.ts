...
export const ResourceRolePhaseDependency = {
  ...
  toJSON(message: ResourceRolePhaseDependency): unknown {
    ...
    message.resourceRoleId !== undefined &&
      (obj.resourceRoleId = message.resourceRoleId);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ResourceRolePhaseDependency>, I>>(
    object: I
  ): ResourceRolePhaseDependency {
    const message = createBaseResourceRolePhaseDependency();
...
export const CreateResourceRolePhaseDependencyInput = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateResourceRolePhaseDependencyInput>, I>
  >(object: I): CreateResourceRolePhaseDependencyInput {
    const message = createBaseCreateResourceRolePhaseDependencyInput();
    message.phaseId = object.phaseId ?? "";
    message.phaseState = object.phaseState ?? false;
    message.resourceRoleId = object.resourceRoleId ?? "";
...
export const ResourceRolePhaseDependencyList = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.resourceRolePhaseDependencies.push(
            ResourceRolePhaseDependency.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): ResourceRolePhaseDependencyList {
    return {
      resourceRolePhaseDependencies: Array.isArray(
        object?.resourceRolePhaseDependencies
      )
        ? object.resourceRolePhaseDependencies.map((e: any) =>
            ResourceRolePhaseDependency.fromJSON(e)
          )
        : [],
    };
  },
  ...
  toJSON(message: ResourceRolePhaseDependencyList): unknown {
    ...
    if (message.resourceRolePhaseDependencies) {
      obj.resourceRolePhaseDependencies =
        message.resourceRolePhaseDependencies.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<ResourceRolePhaseDependencyList>, I>>(
    ...
    message.resourceRolePhaseDependencies =
      object.resourceRolePhaseDependencies?.map((e) =>
        ResourceRolePhaseDependency.fromPartial(e)
      ) || [];
    return message;
  },
};
