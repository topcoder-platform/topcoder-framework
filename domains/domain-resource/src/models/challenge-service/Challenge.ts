...
export const ChallengeService = {
  ...
  updateChallengePhases: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateChallengePhasesRequest.decode(value),
    responseSerialize: (value: UpdateOperationResult) =>
      Buffer.from(UpdateOperationResult.encode(value).finish()),
...
export interface ChallengeClient extends Client {
  ...
  updateChallengePhases(
    ...
    callback: (
      ...
      response: UpdateOperationResult
    ) => void
  ): ClientUnaryCall;
  updateChallengePhases(
    request: UpdateChallengePhasesRequest,
