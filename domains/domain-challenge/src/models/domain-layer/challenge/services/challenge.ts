...
import { LookupCriteria, ScanRequest, ScanResult, UpdateResult } from "@topcoder-framework/lib-common";
...
export interface ChallengeClient extends Client {
  ...
  lookup(request: LookupCriteria, callback: (error: ServiceError | null, response: Challenge) => void): ClientUnaryCall;
  lookup(
