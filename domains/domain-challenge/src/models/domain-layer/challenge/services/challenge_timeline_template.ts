...
export type ChallengeTimelineTemplateService =
  typeof ChallengeTimelineTemplateService;
export const ChallengeTimelineTemplateService = {
  ...
  lookup: {
    ...
    responseDeserialize: (value: Buffer) =>
      ChallengeTimelineTemplate.decode(value),
  },
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateChallengeTimelineTemplateInput.decode(value),
    responseSerialize: (value: ChallengeTimelineTemplate) =>
      Buffer.from(ChallengeTimelineTemplate.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      ChallengeTimelineTemplate.decode(value),
...
export interface ChallengeTimelineTemplateServer
...
export interface ChallengeTimelineTemplateClient extends Client {
  ...
  lookup(
    ...
    callback: (
      ...
      response: ChallengeTimelineTemplate
    ) => void
  ): ClientUnaryCall;
  lookup(
    request: LookupCriteria,
  ...
  update(
    ...
    callback: (
      error: ServiceError | null,
      response: ChallengeTimelineTemplateList
    ) => void
  ): ClientUnaryCall;
  update(
    request: UpdateChallengeTimelineTemplateInput,
