...
export type LegacyChallengePaymentService =
  typeof LegacyChallengePaymentService;
export const LegacyChallengePaymentService = {
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateLegacyChallengePaymentInput.decode(value),
  ...
  update: {
    ...
    requestDeserialize: (value: Buffer) =>
      UpdateLegacyChallengePaymentInput.decode(value),
  ...
  delete: {
    ...
    requestDeserialize: (value: Buffer) =>
      DeleteLegacyChallengePaymentInput.decode(value),
...
export interface LegacyChallengePaymentServer
...
export interface LegacyChallengePaymentClient extends Client {
  get(
    ...
    callback: (
      ...
      response: LegacyChallengePaymentList
    ) => void
  ): ClientUnaryCall;
  get(
    request: GetLegacyChallengePaymentInput,
