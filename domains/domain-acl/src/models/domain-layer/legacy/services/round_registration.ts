...
export type LegacyRoundRegistrationService =
  typeof LegacyRoundRegistrationService;
export const LegacyRoundRegistrationService = {
  ...
  create: {
    ...
    requestDeserialize: (value: Buffer) =>
      CreateRoundRegistrationInput.decode(value),
...
export interface LegacyRoundRegistrationServer
