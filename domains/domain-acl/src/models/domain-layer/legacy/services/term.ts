...
export interface LegacyTermClient extends Client {
  getProjectRoleTermsOfUseXrefs(
    ...
    callback: (error: ServiceError | null, response: ProjectRoleTermsOfUseXrefList) => void,
  ): ClientUnaryCall;
  getProjectRoleTermsOfUseXrefs(
    request: GetProjectRoleTermsOfUseXrefInput,
    metadata: Metadata,
...
export const LegacyTermClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): LegacyTermClient;
